...
//
//		mLeftPlayer = std::make_unique<Pong::Player>();
//		mRightPlayer = std::make_unique<Pong::Player>();
//	}
//
...
//	}
//private:
//	std::unique_ptr<Pong::Player> mLeftPlayer;
//	std::unique_ptr<Pong::Player> mRightPlayer;
//
